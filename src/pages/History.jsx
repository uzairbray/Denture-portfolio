import { DentalArchSVG, RulerEdge } from '../components/BannerDecorations'

const subSections = [
  { label: '2.1', title: 'Main Complaint' },
  { label: '2.2', title: 'Medical History' },
  { label: '2.3', title: 'Dental History' },
]

export default function History() {
  return (
    <div className="min-h-[68vh] bg-ink flex flex-col justify-end relative overflow-hidden">
      {/* Backdrop — cooler left / warm right, different balance from the hero */}
      <div
        className="absolute inset-0"
        style={{
          background:
            'radial-gradient(ellipse 65% 70% at 78% 38%, rgba(139,69,19,0.17) 0%, transparent 58%), radial-gradient(ellipse 50% 65% at 10% 72%, rgba(70,95,88,0.13) 0%, transparent 55%), linear-gradient(155deg, #1c1917 0%, #221a14 55%, #1a1f1a 100%)',
        }}
      />
      {/* Blueprint grid */}
      <div
      ...
      <div
        className="absolute right-0 top-0 w-[400px] h-[440px] pointer-events-none max-[820px]:w-[200px] max-[820px]:h-[220px]"
        style={{ opacity: 0.055 }}
      >
      ...
      <div className="relative z-[2] px-[72px] pt-20 pb-[60px] max-[820px]:px-6 max-[820px]:pt-16 max-[820px]:pb-10">
        ...
        >
          Patient<br />
          <em className="italic text-sand">History</em>
        </h1>
        ...
        <p className="text-[13px] text-white/[0.45] font-light leading-[1.82] max-w-[500px] mb-9">
          A comprehensive account of Mrs Watkins' presenting complaint, systemic medical background,
          and dental history — the clinical foundation on which all treatment decisions were based.
        </p>

        {/* Sub-section index */}
        <div className="flex gap-8 flex-wrap pt-5 border-t border-sand/[0.10]">
          {subSections.map(s => (
